...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8869689548:AAGyuNGE0sXCh1FfaBFUrA0EUKiFqpNFs7g")
...
ADMINS = int(os.environ.get("ADMINS", "7660916897"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003946714192")
